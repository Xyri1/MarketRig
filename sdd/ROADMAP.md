...
- **The Windows E6 pair is half run** — the Codex cell passed on 2026-09-08 (`experiment-e6-codex-1788861052`); the Claude Code cell is outstanding and completes R6's first entry check (per D83).
