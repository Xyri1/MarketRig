...
| Route | Body | Answers |
| --- | --- | --- |
| `GET /approvals?state=PENDING\|DECIDED\|ALL` (default `PENDING`) | — | `200 {approvals: [Approval…]}` newest first by `requested_at_ns` |
