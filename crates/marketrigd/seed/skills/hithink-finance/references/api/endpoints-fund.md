...
```bash
marketrig research hithink fund/profile/detail --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/portfolio/holdings --param thscode=510300.SH
```
...
```bash
marketrig research hithink fund/performance/nav --param thscode=025480.OF --param range=year --param nav_type=unit%2Cadj
```
...
```bash
marketrig research hithink fund/performance/returns --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/holders/detail --param thscode=025480.OF --param merge_scope=all
```
...
```bash
marketrig research hithink fund/market/snapshot --param thscode=510300.SH
```
...
```bash
marketrig research hithink fund/market/historical --param thscode=510300.SH --param interval=1d --param start=1704038400000 --param end=1735660799000
```
...
```bash
marketrig research hithink fund/companies/detail --param company_id=<company-id>
```
...
```bash
marketrig research hithink fund/portfolio/industry-allocation --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/performance/indicators-historical --param thscode=025480.OF --param start=1704038400000 --param end=1735660799000
```
...
```bash
marketrig research hithink fund/performance/drawdowns --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/holders/top --param thscode=588000.SH --param limit=10
```
...
```bash
marketrig research hithink fund/corporate-actions/dividends --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/diagnostics/detail --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/financials/indicators --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/financials/income-statements --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/financials/balance-sheets --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/managers/investment-style --param manager_id=<manager-id>
```
...
```bash
marketrig research hithink fund/managers/performance --param manager_id=<manager-id> --param range=year
```
...
```bash
marketrig research hithink fund/managers/experience --param manager_id=<manager-id>
```
...
```bash
marketrig research hithink fund/managers/detail --param manager_id=<manager-id>
```
...
```bash
marketrig research hithink fund/news/article-list --param thscode=025480.OF --param limit=20
```
...
```bash
marketrig research hithink fund/offerings/list --param subscribe=active
```
...
```bash
marketrig research hithink fund/portfolio/stock-history --param thscode=025480.OF --param report_type=<type> --param end_date=<date>
```
...
```bash
marketrig research hithink fund/portfolio/stock-report-dates --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/portfolio/bond-history --param thscode=025480.OF --param report_type=<type> --param end_date=<date>
```
...
```bash
marketrig research hithink fund/portfolio/bond-report-dates --param thscode=025480.OF
```
...
```bash
marketrig research hithink fund/portfolio/asset-allocation --param thscode=025480.OF
```
