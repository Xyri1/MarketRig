...
```bash
# 批量模式：指定股票
marketrig research hithink a-share/prices/snapshot --param thscodes=600519.SH,000001.SZ

# 全市场分页模式
marketrig research hithink a-share/prices/snapshot --param limit=100 --param offset=0
```
...
```bash
marketrig research hithink a-share/prices/historical --param thscode=600519.SH --param interval=1d --param start=1716105600000 --param end=1747641600000 --param adjust=forward
```
...
```bash
# 茅台全部历史复权事件
marketrig research hithink a-share/corporate-actions/adjustment-factors --param thscode=600519.SH

# 平安银行近 5 年事件
marketrig research hithink a-share/corporate-actions/adjustment-factors --param thscode=000001.SZ --param from=2021-01-01 --param to=2026-01-01
```
