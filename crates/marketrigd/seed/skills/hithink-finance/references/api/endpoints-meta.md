...
```bash
marketrig research hithink meta/tickers/search --param q=贵州茅台 --param limit=5
```
...
```bash
marketrig research hithink meta/tickers/list --param exchange=SH,SZ --param asset_type=a-share --param limit=1000 --param offset=0
```
