...
```bash
# 概念板块列表
marketrig research hithink a-share-index/catalog/ths-index-list --param tag=cn_concept

# 行业指数列表
marketrig research hithink a-share-index/catalog/ths-index-list --param tag=industry
```
...
```bash
# 沪深 300 成分股
marketrig research hithink a-share-index/constituents/ths-stock-list --param thscode=000300.SH

# 某概念板块成分股
marketrig research hithink a-share-index/constituents/ths-stock-list --param thscode=886042.TI
```
...
```bash
marketrig research hithink a-share-index/prices/snapshot --param thscodes=000300.SH,000001.SH
```
...
```bash
# 沪深 300 近一年日 K
marketrig research hithink a-share-index/prices/historical --param thscode=000300.SH --param interval=1d --param start=1716105600000 --param end=1747641600000
```
