...
```bash
# 茅台最近 4 期年报利润表
marketrig research hithink a-share/financials/income-statements --param thscode=600519.SH --param period=annual --param limit=4

# 区间模式
marketrig research hithink a-share/financials/income-statements --param thscode=600519.SH --param period=annual --param start=1577836800000 --param end=1893456000000
```
...
```bash
marketrig research hithink a-share/financials/balance-sheets --param thscode=600519.SH --param period=annual --param limit=5
```
...
```bash
marketrig research hithink a-share/financials/cash-flow-statements --param thscode=600519.SH --param period=quarterly --param limit=8
```
...
```bash
# 茅台 2024 年报财务指标
marketrig research hithink a-share/financials/indicators --param thscode=600519.SH --param report=2024-4
```
