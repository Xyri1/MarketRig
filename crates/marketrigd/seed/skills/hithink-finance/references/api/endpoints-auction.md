...
```bash
marketrig research hithink a-share/auction/snapshot --param thscodes=600519.SH,000001.SZ --param stage=final
```
...
```bash
marketrig research hithink a-share/auction/short-term-benchmark --param date=2026-08-14
```
